...
import { ChevronRight, Replay, Person, Delete, Archive, Print } from '@material-ui/icons';
    ...
    return (
        <div className="caixaEntrada">
             <Grid container spacing={3}>
                ...
                <Grid item xs={8}>
                    <div className="container-open-email">
                        <div className="menu-options-email">
                        ...
                        <div className="container-email-open">
